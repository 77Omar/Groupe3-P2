...
<html lang="en" class="h-100">
  ...
  <div class="container-fluid bloc mt-2 w-100 col-md-10 col-sm-10" id="form-admin">
    <div class="row justify-content-start align-items-center mb-3"  style="background:linear-gradient(180deg, #C4C4C4 11.84%, rgba(255, 255, 255, 0) 100%), #C4C4C4; height:150px;">
    <div class="col-3">
  <?php
  ...
  <nav class="w-100" id="nav">
    <ul class="nav">
      ...
      <div class="w-50 p-2">
        <li class="nav-item rounded border border-white img-responsive">
